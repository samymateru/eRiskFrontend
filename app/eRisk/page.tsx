...
export default function eRiskHomePage() {
  return (
    <div className="flex flex-col gap-5 w-full px-2 py-3 overflow-y-auto overflow-x-hidden bg-white">
      ...
      <div className="flex bg-neutral-100 rounded-md flex-col gap-2">
        <section>
          <Label className="font-semibold text-[17px] pl-2">Top Risk</Label>
        </section>
